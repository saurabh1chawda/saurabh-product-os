...
export class BeginExecutionInput {
  private readonly __beginExecutionInputBrand!: never;
  ...
  equals(other: BeginExecutionInput | undefined): boolean {
    return other instanceof BeginExecutionInput
...
function assertInstance<T>(value: unknown, constructor: new (...args: never[]) => T): asserts value is T {
  if (!(value instanceof constructor)) {
    throw new TypeError("Invalid BeginExecutionInput value.");
  }
}
